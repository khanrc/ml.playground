...
if __name__ == "__main__":
    ...
    stn = STNs(name=stn_name, locnets_type='fc', lr=0.0001, use_residual_M=True)
    ...
    #     np.random.shuffle(train)
        ...
        stn_cur_acc, stn_summary = sess.run([stn.accuracy, stn.summary_op], {stn.X: X_test, stn.y: y_test})
        ...
        print("[{}/{}] (stn) avg_loss: {:.3f}, acc: {:.3f}".format(epoch+1, epoch_n, stn_avg_loss, stn_cur_acc))
